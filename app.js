...
const T = {
  ja: {
    ...
    installTitle: '📱 iPhoneのホーム画面に追加する方法',
    installNote: '‼️ Safariのみ対応・ChromeはNG。インストール不要でアプリとして使えます。',
    installStep1T: 'このページをSafariで開く',
    installStep1D: 'iPhoneではChromeではなくSafariを使ってください。',
    installStep2T: '共有ボタン（□↑）をタップ',
    installStep2D: 'Safariの画面下部にある共有アイコンを押します。',
    installStep3T: '「ホーム画面に追加」を選択',
    installStep3D: '名前はそのままでOK。「追加」を押して完了。',
    installStep4T: 'ホーム画面のアイコンから起動',
    installStep4D: 'アプリとして毎日使えます。',
    installQRCaption: 'パソコンで見ている方は、iPhoneのカメラでこのQRコードを読み取るとそのままアプリを開けます。',
    installPrivacy: '⚠️ このアプリはブラウザ上で動作するPWA（Progressive Web App）です。データはお使いの端末内にのみ保存され、外部サーバーには送信されません。',
    installMore: '詳しい紹介ページを見る ›',
  ...
  en: {
    ...
    installTitle: '📱 Add to your iPhone Home Screen',
    installNote: '‼️ Safari only (not Chrome). No installation needed — use it like an app.',
    installStep1T: 'Open this page in Safari',
    installStep1D: 'On iPhone, use Safari instead of Chrome.',
    installStep2T: 'Tap the Share button (□↑)',
    installStep2D: 'It is at the bottom of the Safari screen.',
    installStep3T: 'Select "Add to Home Screen"',
    installStep3D: 'Keep the name as is and tap "Add".',
    installStep4T: 'Launch from the Home Screen icon',
    installStep4D: 'Use it as an app every day.',
    installQRCaption: 'Viewing on a computer? Scan this QR code with your iPhone camera to open the app directly.',
    installPrivacy: '⚠️ This is a PWA (Progressive Web App) that runs in your browser. All data stays on your device and is never sent to any server.',
    installMore: 'See the full introduction page ›',
